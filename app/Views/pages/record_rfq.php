 <div class="container-fluid">
     <div class="container-fluid">
         <div class="card">
             <div class="card-body">
                 <div class="col-md-12">
                     <h5 class="card-title fw-semibold mb-4">RFQ Record</h5>
                                         ...
                                         <form action="#" method="post" id="add_post_form">
                                             <div class="modal-body">
                                                 <div class="form-group">
                                                     <label>ID RFQ</label>
                                                     <input type="text" class="form-control" id="rfq_id" name="rfq_id" disabled>
                                                 </div>
                                                 <div class="form-group">
                                                     <label>Product</label>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <input type="text" class="form-control" id="production_type" name="production_type"></textarea>
                                                 </div>
                                                 <div class="form-group">
                                                     <label>QTY</label>
 ...
 <script>
     $(function() {
         ...
         function fetchAllPosts() {
             ...
             $.ajax({
                 url: '<?= base_url('RecordHandle/RFQRead') ?>',
                 method: 'get',
             ...
             $("#add_post_form").submit(function(e) {
                 ...
                 $.ajax({
                     method: "post",
                     url: '<?= base_url('RecordHandle/RFQCreate') ?>',
                     data: formdata,
                     dataType: "JSON",
                     success: function(response) {
                         console.log(response);
